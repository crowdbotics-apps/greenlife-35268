      ...
      <View style={styles.View_1_232}>
        <View style={styles.View_1_255}>
          <View style={styles.View_1_256}>
            <Text style={styles.Text_1_256}>Серийный номер</Text>
          </View>
          <View style={styles.View_1_257} />
          <View style={styles.View_1_258}>
            <Text style={styles.Text_1_258}>Ввести</Text>
          </View>
        </View>
        <View style={styles.View_1_259}>
          <Text style={styles.Text_1_259}>_ _ _ _ _ _ _ _ _ _ _ _</Text>
        </View>
      </View>
    </ScrollView>
  )
